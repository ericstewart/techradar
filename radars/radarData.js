...
document.title = "Eric Stewart's Technology Radar (August 2015)";
...
var radar_data = [
    { "quadrant": "Techniques",
        ...
        "color" : "#8FA227",
        "items" : [ 
            { name: 'Git flow ^', pc: { r: 330, t: 133 }, movement: 'c' },
            { name: 'Pull Requests ^', pc: { r: 130, t: 133 }, movement: 'c' },
            ...
            {"name":"Data Informed Decion Making", "pc":{"r":120,"t":110},"movement":"c"},
            {"name":"Polygot Programming", "pc":{"r":140,"t":170},"movement":"c"},
            ...
            {"name":"Valuable, cheap tests", "pc":{"r":80,"t":150},"movement":"c"},
            {"name":"Sacrificial Architecture", "pc":{"r":80,"t":100},"movement":"c"},   
            {"name":"Immutable Architecture", "pc":{"r":160,"t":100},"movement":"c"},   
            {"name":"Sensible defaults", "pc":{"r":80,"t":150},"movement":"c"},   
            {"name":"Dependency Injection", "pc":{"r":180,"t":130},"movement":"c"},   
...
{ name: 'Docker', pc: { r: 170, t: 19 }, movement: 't' },
 ...
 //{ name: 'Android Studio',    pc: { r: 180, t: 66 },    movement: 'c',    domain: 'mobile, dev' },
  ...
  { name: 'Git',    pc: { r: 50, t: 73 },    movement: 'c' },

  { name: 'Ansible',    pc: { r: 280, t: 70 },    movement: 'c' },  
            { name: 'Chef',    pc: { r: 280, t: 65 },    movement: 'c' },  
            { name: 'Puppet',    pc: { r: 240, t: 60 },    movement: 'c' },  
  { name: 'HipChat',    pc: { r: 280, t: 78 },    movement: 'c' },
  { name: 'Slack',    pc: { r: 180, t: 78 },    movement: 'c' },
  { name: 'Trello',    pc: { r: 260, t: 75 },    movement: 'c' },
  { name: 'LeanKit',    pc: { r: 170, t: 75 },    movement: 'c' },
  ...
  { name: 'Datomic',    pc: { r: 150, t: 5 },    movement: 'c' }, 
  { name: 'Subversion',    pc: { r: 330, t: 18 },    movement: 'c' }
    ...
    { "quadrant": "Languages & Frameworks",
        ...
        "items" : [ 
            ...
            {"name":"Java 8", "pc":{"r":230,"t":355},"movement":"c"},   
            {"name":"Elixir", "pc":{"r":260,"t":340},"movement":"c"},   
            {"name":"Groovy", "pc":{"r":190,"t":280},"movement":"c"},

            {"name":"Swift", "pc":{"r":220,"t":300},"movement":"c"},
            {"name":"Scala - the good parts ^", "pc":{"r":250,"t":320},"movement":"c"},   
            {"name":"Serverside Javascript", "pc":{"r":280,"t":275},"movement":"c"},   
            {"name":"Coffeescript", "pc":{"r":270,"t":282},"movement":"c"},
            {"name":"Functional Reactive Programming", "pc":{"r":225,"t":330},"movement":"c"},   
            {"name":"Clojure", "pc":{"r":70,"t":310},"movement":"c"},
            ...
            {"name":"ASP Classic", "pc":{"r":375,"t":340},"movement":"c"},
